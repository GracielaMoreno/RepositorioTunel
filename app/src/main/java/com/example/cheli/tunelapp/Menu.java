    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
                        ...
                        builder.setMessage(Mensaje1)
                                .setPositiveButton("Continuar", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        bundle2.putString("cl_codigo", cl_codigo);
                                        bundle2.putString("cut_codigo", cut_codigo);
                                        bundle2.putString("correo", correo);
                                        bundle2.putString("Vehiculos", vehiculos);
                                        bundle2.putString("nombre", nombreUsuario);
                                        bundle2.putString("tipoDoc", tipoDoc);
                                        bundle2.putString("cedula", l);
            ...
            case R.id.opcion_4:
                ...
                bundle3.putString("nombre", nombreUsuario);
